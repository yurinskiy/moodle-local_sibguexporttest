...
class course_config_form extends course_settings_form {
    protected function definition() {
        ...
        // Настройка тестов
        $header = $mform->createElement('header', 'configtest', 'Настройки генерации билетов');
        ...
        $hasFirstPage = $mform->createElement('selectyesno', 'hasfirstpage', 'Добавлять титульную страницу');
        $mform->insertElementBefore($hasFirstPage, 'buttonar');

        $hasBreakFirstPage = $mform->createElement('selectyesno', 'hasbreakfirstpage', 'Добавлять разрыв страницы после титульной страницы');
        ...
        $versionFrom = $mform->createElement('text', 'versionfrom', 'Начинать нумерацию с:');
